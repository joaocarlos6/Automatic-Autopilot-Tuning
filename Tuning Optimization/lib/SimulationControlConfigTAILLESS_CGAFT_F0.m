...
PiccoloGainVersion = "G44 AFT Flap 0 (Gen " + FTV +")";
modelScale = '7P';
...
ThrottleRateMax         = 0.25; % 1/s; not in documentation, but in PCC
...
AltRateError2Pitch      = 0.70;  
AltRateErrorInt2Pitch   = 0.95;  
...
% Tuning
PitchRateError2Accel    = 3.7; 
PitchRateErrorInt2Accel = 7.35; 
PitchDampingTrust       = 0;
...
AileronTrim=0;
% 
RollRateError2Accel     = 8; %
RollRateErrorInt2Accel  = 9; %
RollDampingTrust        = 0;
...
IASfinalCMD = 1.20 * IASmin;
IASshortCMD = 1.17 * IASmin;
...
ShortDescentSlope_Deg = testPlans(testIndx).descentSlope-0.5; % Deg, 0.25 degree reduction (consistent with 16P)
...
RotationElevator        = -3; % deg
RotationTime            = 4;   % s
RotationSpeedFraction   = 1.4;

...
PiccoloGainVersion = "G42 AFT Flap 0 (Gen " + FTV +")";
modelScale = '7P';
...
%% Pitch Control
ElevatorTrim = -3; % default: -5

PitchMaxAccel   = 1.0; % rad/s^2; used in rate limiter
PitchBandwidth  = 0.45; %Hz 1.10

% Tuning
PitchRateError2Accel    = 3.1; 
PitchRateErrorInt2Accel = 6.3; 
PitchDampingTrust       = 0;
PitchStiffnessTrust     = 0; %

%Vehicle Properties
ElevatorPower   = -0.002668;% /deg
...
IASfinalCMD = 1.11 * IASmin;
IASshortCMD = 1.08 * IASmin;

...
PiccoloGainVersion = "G43 AFT Flap 0 (Gen " + FTV +")";
modelScale = '7P';
...
% AltRate control gains
AltRateError2Pitch      = 0.1;  
AltRateErrorInt2Pitch   = 0.85;  
...
%% Pitch Control
ElevatorTrim = -3.7; % default: -5

PitchMaxAccel   = 1.0; % rad/s^2; used in rate limiter
PitchBandwidth  = 0.6; %Hz 1.10

% Tuning
PitchRateError2Accel    = 1.5; 
PitchRateErrorInt2Accel = 8.8; 
PitchDampingTrust       = 0;
PitchStiffnessTrust     = 1; %

%Vehicle Properties
ElevatorPower   = -0.00267;% /deg
PitchDamping    = -0.1; % Cm/qbar
...
RollBandwidth   = 1.0; %Hz; 228b bug fixes this value to 1.3 for flight and 1.0 for landing
...
AileronTrim=0;
% 
RollRateError2Accel     = 13; %
RollRateErrorInt2Accel  = 19; %
RollDampingTrust        = 0;
...
%
YawRateErr2Rudder       = 10;
SideForceErrInt2Rudder  = 0.1; % it is used in another
...
IASmax          = 38.9; % Set as static limit (ldg limits)
...
ElevatorDeflectionRate  = 5; %deg/s

...
PiccoloGainVersion = "G43 FWD Flap0 (Gen " + FTV +")";
modelScale = '7P';
...
AltRateError2Pitch      = 0.15;  
AltRateErrorInt2Pitch   = 0.78;  
AltRateCmd2Pitch        = 0.25; 
...
IASflareCMD = 0.0 * IASmin; % Disable throttle control in flare for consistency
...
flapRate    = 1; % Flap deployment rate (deg/s)

dCl_per_dFlap = 0; %[/deg]
dCd_per_dFlap = 0.010775; %[/deg] Change in Cd per flap deflection. Appears unused in controller.. 
...
LaunchRollingElevator   = -2.0; % deg
RotationElevator        = -5.00;% deg
RotationTime            = 4;   % s
RotationSpeedFraction   = 1.3;

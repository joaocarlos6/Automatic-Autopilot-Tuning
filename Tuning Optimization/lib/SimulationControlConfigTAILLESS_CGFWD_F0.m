...
PiccoloGainVersion = "G44 FWD Flap 0 (Gen " + FTV +")";
modelScale = '7P';
...
% Track Control
TrackConvergence        = 0.19;%????
HeadingErr2TurnRate     = 0.4;  %????
...
RotationElevator        = -5;% deg
RotationTime            = 4;   % s
RotationSpeedFraction   = 1.26;

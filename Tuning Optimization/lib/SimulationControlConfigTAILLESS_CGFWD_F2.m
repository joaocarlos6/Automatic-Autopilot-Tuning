...
PiccoloGainVersion = "G43 FWD Flap2 (Gen " + FTV +")";
modelScale = '7P';
...
PitchRateErrorInt2Accel = 7.3; 
PitchDampingTrust       = 0;
PitchStiffnessTrust     = 1; %

%Vehicle Properties
ElevatorPower   = -0.00293;% /deg
PitchDamping    = -0.8; % Cm/qbar
PitchStiffness  = -0.0012; % /deg
...
IASfinalCMD = 1.02 * IASmin;
IASshortCMD = 0.98 * IASmin;
IASflareCMD = 0 * IASmin;
...
LaunchRollingElevator   = -3.00; % deg
RotationElevator        = -6.00;% deg
RotationTime            = 4;   % s
RotationSpeedFraction   = 0.99;

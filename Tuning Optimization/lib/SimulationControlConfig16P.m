...
% Lateral Axis
XInertia = 105.764;  % kgm^2 % Updated TBF4-TOW1

% XInertia=IXX/3417.17; % Direct from model configuration

% Pitch Axis
YInertia = 108.454;  % kgm^2 % Updated TBF4-TOW1

% YInertia=IYY/3417.17;   % Direct from model configuration

% Directional Axis
ZInertia = 198.456;  % kgm^2 % Updated TBF4-TOW1
...
% Increased I-term
PowerError2Throttle     = 1.0; %0.9
PowerErrorInt2Throttle  = 0.4; %0.2
ThrottlePredictionTrust = 0.2; %0.9

% Low pass filters
ThrottleLpfCutoff = 0.35; % Hz

EnergyBandwidth = 0.04; %Hz;0.02
...
SideForceErrInt2Rudder = 2.0; % it is used in another
...
% Flap-up
IASfinalCMD = 1.12 * IASmin;
IASshortCMD = 1.12 * IASmin;
...
% Flare Vertical Rate Command 
FlareHeight = 5; %m 4.2 is minimum at 3.5deg slope, 3.7m at 3.0deg,
FlareVerticalRate_mps = -0.4;

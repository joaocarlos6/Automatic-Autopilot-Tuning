...
PiccoloGainVersion = "G41.87 Tailless, 2.3 m Flare, Flare TLA w TEC @0.96 Slew Logic 2 (0.045 /s, 0.50 Max, 0.10 Min, 0.10 /s Rollout and Elev 2Deg Trigger) (Gen " + FTV +")";
modelScale = '7P';
...
ControlAllocation = "M8 FTD"; % Mixing Matrix M8 for tailless
...
%G41 Tuning
AltRateError2Pitch      = 0.55; % 45, 60
AltRateErrorInt2Pitch   = 0.61; %50, 55
AltRateCmd2Pitch        = 0.0; %15
...
PitchBandwidth  = 1.04; %Hz 1.10

% Tuning
PitchRateError2Accel    = 1.8; %1.8
PitchRateErrorInt2Accel = 5.6; %5.6
PitchDampingTrust       = 0.0;
PitchStiffnessTrust     = 0.25; %
...
PitchRateLpfCutoff  = 3; %Hz; used for filtering the elevator ouput
...
RollBandwidth   = 1.00; %Hz;Original Value 1.1 228b bug fixes this value to 1.3 for flight and 1.0 for landing?
...
% Updated taxi gains. These should be carried to tailless config. 
% Test these for Gen 3 vehicle, may work without modification
ldg_TrackY2Vy               = 0.17;
...
ldg_Vy2NosegearScalingPower = 0.60;
    ...
    % Continued tuning for 2C tailless - more aggressive to account for
    % reduced yaw authority
%     ldg_TrackY2Vy                 = 0.17;
%     ldg_TrackVyErrInt2Nosegear    = 0.01/1.4;
%     ldg_TrackVyErrPro2Nosegear    = 0.82/15;
%     ldg_YawRate2Nosegear          = 0.065;
%     ldg_Y2VyScalingPower          = 0.0;
%     ldg_Vy2NosegearScalingPower   = 0.48; % Reduced scaling pwr
...
IASmax          = 35; % Set as static limit (ldg limits)
...
IASflareCMD = 0.96 * IASmin; % Disable throttle control in flare for consistency
...
FlareHeight             = 2.3; %m 2.5
FlareVerticalRate_mps   = -0.1; %G62 configured with -0.1
...
RotationElevator        = -5.50;% deg
RotationTime            = 3.5;   % s
RotationSpeedFraction   = 1.04;
